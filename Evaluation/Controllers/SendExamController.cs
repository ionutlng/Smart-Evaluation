...
{
    public class SendExamController : Controller
    {

        private readonly EvaluationDBContext _context;

        public SendExamController(EvaluationDBContext context)
        {
           _context = context;
        }
        ...
        public IActionResult SendExam(int nrquestions, int time, int examDifficulty, int courseId)
        {
